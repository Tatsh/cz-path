...
1. Run `uv run pytest --cov cz_path --cov-branch --cov-report term-missing:skip-covered`
...
4. Run `uv run pytest --cov cz_path --cov-branch --cov-report term-missing:skip-covered`
